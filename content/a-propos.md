...
::callout{icon="i-lucide-flag" color="secondary"}
...
::card-group
:::card{icon="i-lucide-users" title="Convivialité"}
La pétanque avant tout comme un moment de partage, entre une partie et une
pause à l'ombre des platanes.
:::

:::card{icon="i-lucide-door-open" title="Ouverture"}
Un club accessible à toutes et à tous, des débutants aux licenciés
confirmés.
:::

:::card{icon="i-lucide-trophy" title="Esprit sportif"}
Le goût de la compétition, toujours dans le respect de l'adversaire.
:::
::

## Nos installations

Le club dispose d'installations pour jouer toute l'année : un **boulodrome
couvert de 12 terrains** (pratique par temps de pluie ou en hiver) et **plus de
90 terrains en extérieur**.
...
::accordion
:::accordion-item{label="Championnats et coupes"}
Le club engage de nombreuses équipes (seniors, vétérans, masculines,
féminines et mixtes) dans les championnats départementaux et régionaux,
ainsi qu'en Coupe de France et Coupe du Finistère.
:::

:::accordion-item{label="Concours officiels FFPJP"}
Chaque année, le club organise 4 concours officiels FFPJP, pouvant
accueillir jusqu'à 500 joueurs, ainsi que des journées de championnat, de
coupe et des rassemblements vétérans.
:::

:::accordion-item{label="Animation estivale"}
En juillet et août, des concours populaires en doublette, ouverts à tous,
ont lieu tous les mercredis à 14h. Le club organise aussi un concours
traditionnel le samedi de la Fête des Pommiers, ainsi qu'un événement
caritatif pour le Téléthon en hiver.
:::
::
...
*Composition à mettre à jour par le bureau depuis Nuxt Studio.*

Pour toute question sur la vie de l'association, écrivez-nous depuis la page
[Contact & Adhésion](/contact).
